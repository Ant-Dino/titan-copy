...
const PsReportingComponent = () => {
    ...
    useEffect(() => {
        // emulate $rootScope and $scope.$on logic here
        // Emulate UserInfo.getUser() logic here for initial rights and tenant setting
    }, []);

    // Logic for inValidateConfirm and inValidateProcess should be adapted here

    const search = () => {
        console.log('Search functionality to be implemented.');
    };

    // Additional functions and hooks go here
